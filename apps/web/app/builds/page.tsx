      ...
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-8">
        <header className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500">
              Pipeline de build que produce imágenes Docker reutilizables por
              instancia.
            </p>
          </div>
          <Link
        ...
        <section className="rounded-2xl border border-dashed border-zinc-800 bg-zinc-900/30 p-12 text-center">
          <h2 className="text-xl font-semibold text-zinc-100">
            Pipeline de Build — pendiente F9.3
          </h2>
          <p className="mt-2 text-sm text-slate-500">
            El módulo de builds se entregará en la fase F9.3 del refactor
            greenfield.
          </p>
        </section>
      </div>
