...
namespace Aethra.Modules.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260603194113_F121_Totp")]
    partial class F121_Totp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aethra.Modules.Identity.Domain.User", b =>
                {
                    ...
                    b.Property<byte[]>("TotpRecoveryCodesCipher")
                        .HasColumnType("bytea")
                        .HasColumnName("totp_recovery_codes_cipher");

                    b.Property<int>("TotpRecoveryCodesUsedMask")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("totp_recovery_codes_used_mask");

                    b.Property<byte[]>("TotpSecretCipher")
                        .HasColumnType("bytea")
