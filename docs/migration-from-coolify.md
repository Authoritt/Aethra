...
>
> Verificado contra el codigo el 2026-08-02: los endpoints de **environments** y
> **applications** que esta guia usaba (anidados bajo un proyecto, y el grupo de
> applications de primer nivel) NO estan registrados.
...
```text
# PASO NO VERIFICADO: la ruta que este comando usaba no existe (issue #15).
# Se retira el curl en vez de dejarlo. Un comando que da 404 cuesta mas que
# una linea que admite no saber, porque el lector no puede distinguir entre
# "me equivoque yo" y "la documentacion miente".
# Las rutas reales se listan desde /openapi/v1.json de una instancia viva.
```
